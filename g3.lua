...
-- Safety and position calculation
...
local function startTeleporting()
    stopTeleporting()
    if not Options.TeleportEnabled.Value or Options.TargetPlayer.Value == "None" then return end
...
local function killLoop()
    ...
    -- Use **local player's weapon** for distance
...
autoSkipToggle:OnChanged(handleGamemodeSkip)
...
local killPlayersDropdown = Tabs.Automation:AddDropdown("KillTargets", { Title = "Select Targets", Values = {"None"}, Multi = true, Default = {} })
