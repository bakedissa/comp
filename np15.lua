...
local function teleportToTarget()
    ...
    if onSameTeam() then
        ...
        if not lockedEnemyPosition then
            ...
            debugAction("teleport", "Enemy team. Locked new position using target's Y-axis with -3 offset.")
        end
